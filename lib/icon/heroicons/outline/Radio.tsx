...
// @ts-ignore
function RadioIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "Radio", size, color, overrides = {}, ...restProps } = props;
