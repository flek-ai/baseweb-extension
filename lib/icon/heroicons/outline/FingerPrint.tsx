...
// @ts-ignore
function FingerPrintIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "FingerPrint", size, color, overrides = {}, ...restProps } = props;
