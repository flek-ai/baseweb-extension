...
function QuestionMarkCircleIcon(props: IconProps, ref) {
  ...
  const { title = "QuestionMarkCircle", size, color, overrides = {}, ...restProps } = props;
