...
function ChevronDoubleLeftIcon(props: IconProps, ref) {
  ...
  return (
    <Icon
      ...
      {...restProps}
    >
      <path fill="none" d="M18.75 4.5L11.25 12L18.75 19.5M12.75 4.5L5.25 12L12.75 19.5" stroke="#0F172A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </Icon>
  );
}
