...
// @ts-ignore
function CursorArrowRippleIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "CursorArrowRipple", size, color, overrides = {}, ...restProps } = props;
...
const CursorArrowRipple = React.forwardRef<SVGSVGElement, IconProps>(CursorArrowRippleIcon);
