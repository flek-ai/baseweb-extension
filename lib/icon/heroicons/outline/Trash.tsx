...
// @ts-ignore
function TrashIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "Trash", size, color, overrides = {}, ...restProps } = props;
