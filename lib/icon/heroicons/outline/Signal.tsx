...
// @ts-ignore
function SignalIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "Signal", size, color, overrides = {}, ...restProps } = props;
