...
// @ts-ignore
function ChatBubbleOvalLeftEllipsisIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ChatBubbleOvalLeftEllipsis", size, color, overrides = {}, ...restProps } = props;
...
const ChatBubbleOvalLeftEllipsis = React.forwardRef<SVGSVGElement, IconProps>(ChatBubbleOvalLeftEllipsisIcon);
