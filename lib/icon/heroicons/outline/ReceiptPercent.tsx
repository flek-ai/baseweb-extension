...
// @ts-ignore
function ReceiptPercentIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ReceiptPercent", size, color, overrides = {}, ...restProps } = props;
