...
// @ts-ignore
function ArchiveBoxIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ArchiveBox", size, color, overrides = {}, ...restProps } = props;
...
const ArchiveBox = React.forwardRef<SVGSVGElement, IconProps>(ArchiveBoxIcon);
export { ArchiveBox };
