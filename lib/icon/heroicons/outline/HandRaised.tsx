...
// @ts-ignore
function HandRaisedIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "HandRaised", size, color, overrides = {}, ...restProps } = props;
