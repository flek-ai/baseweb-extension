...
// @ts-ignore
function ArchiveBoxArrowDownIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ArchiveBoxArrowDown", size, color, overrides = {}, ...restProps } = props;
