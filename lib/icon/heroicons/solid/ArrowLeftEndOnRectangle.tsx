...
// @ts-ignore
function ArrowLeftEndOnRectangleIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ArrowLeftEndOnRectangle", size, color, overrides = {}, ...restProps } = props;
...
const ArrowLeftEndOnRectangle = React.forwardRef<SVGSVGElement, IconProps>(ArrowLeftEndOnRectangleIcon);
