...
// @ts-ignore
function DocumentArrowDownIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "DocumentArrowDown", size, color, overrides = {}, ...restProps } = props;
...
const DocumentArrowDown = React.forwardRef<SVGSVGElement, IconProps>(DocumentArrowDownIcon);
