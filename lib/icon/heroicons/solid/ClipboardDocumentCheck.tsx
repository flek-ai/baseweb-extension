...
// @ts-ignore
function ClipboardDocumentCheckIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ClipboardDocumentCheck", size, color, overrides = {}, ...restProps } = props;
...
const ClipboardDocumentCheck = React.forwardRef<SVGSVGElement, IconProps>(ClipboardDocumentCheckIcon);
