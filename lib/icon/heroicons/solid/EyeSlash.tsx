...
// @ts-ignore
function EyeSlashIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "EyeSlash", size, color, overrides = {}, ...restProps } = props;
...
const EyeSlash = React.forwardRef<SVGSVGElement, IconProps>(EyeSlashIcon);
export { EyeSlash };
