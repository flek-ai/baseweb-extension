...
// @ts-ignore
function HandThumbUpIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "HandThumbUp", size, color, overrides = {}, ...restProps } = props;
