...
// @ts-ignore
function ArrowDownOnSquareStackIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "ArrowDownOnSquareStack", size, color, overrides = {}, ...restProps } = props;
...
const ArrowDownOnSquareStack = React.forwardRef<SVGSVGElement, IconProps>(ArrowDownOnSquareStackIcon);
