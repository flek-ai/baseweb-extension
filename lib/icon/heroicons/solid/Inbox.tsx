...
// @ts-ignore
function InboxIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "Inbox", size, color, overrides = {}, ...restProps } = props;
...
const Inbox = React.forwardRef<SVGSVGElement, IconProps>(InboxIcon);
export { Inbox };
