...
// @ts-ignore
function BellSnoozeIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "BellSnooze", size, color, overrides = {}, ...restProps } = props;
