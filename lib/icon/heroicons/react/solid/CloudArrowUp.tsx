...
// @ts-ignore
function CloudArrowUpIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "CloudArrowUp", size, color, overrides = {}, ...restProps } = props;
...
const CloudArrowUp = React.forwardRef<SVGSVGElement, IconProps>(CloudArrowUpIcon);
export { CloudArrowUp };
