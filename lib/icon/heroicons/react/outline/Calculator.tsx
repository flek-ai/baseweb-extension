...
// @ts-ignore
function CalculatorIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "Calculator", size, color, overrides = {}, ...restProps } = props;
