...
// @ts-ignore
function CurrencyPoundIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "CurrencyPound", size, color, overrides = {}, ...restProps } = props;
