...
// @ts-ignore
function GlobeEuropeAfricaIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "GlobeEuropeAfrica", size, color, overrides = {}, ...restProps } = props;
