...
// @ts-ignore
function CarIcon(props: IconProps, ref) {
  const [, theme] = useStyletron();
  const { title = "Car", size, color, overrides = {}, ...restProps } = props;
